...
const Expertise = () => {
    ...
    return (
        <div className="bg-[#D8D7CB] min-h-screen h-auto w-full py-8 md:py-12 lg:py-20 px-4 md:px-8 lg:px-16 flex flex-col items-center justify-center gap-4 md:gap-8 lg:gap-12 relative z-[4]">
