...
const NewsLetter = () => {
  return (
    <div className="w-full h-auto bg-[#D0FF71] text-black py-8 md:py-12 lg:py-20 flex flex-col lg:flex-row justify-start lg:justify-between gap-10 px-4 md:px-8 lg:px-16 relative z-[4] ">
